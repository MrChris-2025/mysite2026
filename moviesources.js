...
const serversList = [
    ...
    { id: 'moovie', name: 'Server 12: moovie' },
...
function getStreamUrl(server, type, id, season = 1, episode = 1) {
    if (type === "movie") {
        switch (server) {
            ...
            case "moovie": return `https://moovie.fun/stream/movie/${id}`
        ...
        switch (server) {
            ...
            case "moovie": return `https://moovie.fun/stream/tv-show/${id}/${season}/${episode}`; 
